const VrNestChariot = (function() {
    ...
    function init() {
        ...
        document.getElementById('rideAscend')?.addEventListener('click', onAscend);
        document.getElementById('rideDescend')?.addEventListener('click', onDescend);
        document.getElementById('rideAuto')?.addEventListener('click', onAutoToggle);
        document.getElementById('rideComfort')?.addEventListener('click', onComfortToggle);
        document.getElementById('rideAcrophobia')?.addEventListener('click', onAcrophobiaToggle);
    ...
    function destroy() {
        ...
        const ascendBtn = document.getElementById('rideAscend');
        const descendBtn = document.getElementById('rideDescend');
        const autoBtn = document.getElementById('rideAuto');
        const comfortBtn = document.getElementById('rideComfort');
        const acroBtn = document.getElementById('rideAcrophobia');

        if (ascendBtn) ascendBtn.removeEventListener('click', onAscend);
        if (descendBtn) descendBtn.removeEventListener('click', onDescend);
        if (autoBtn) autoBtn.removeEventListener('click', onAutoToggle);
        if (comfortBtn) comfortBtn.removeEventListener('click', onComfortToggle);
        if (acroBtn) acroBtn.removeEventListener('click', onAcrophobiaToggle);
